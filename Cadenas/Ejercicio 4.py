...
numberPhone = input("Ingrese el numero de telefono con formato prefijo-numero-extension: ")
lista = numberPhone.split("-",2) 
print(f"Prefijo: {lista[0]}")
print(f"Numero: {lista[1]}")
print(f"Extension: {lista[2]}")